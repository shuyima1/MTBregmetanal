function [f,f_ko,v,v_ko,status1,lostxns,probtfgene] =  promv2(model,expression,expressionid,regulator,targets,litevidence,prob_prior,subsets,v11,v12,KAPPA,datathresh,probtfgene,sizeflag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
...
if (~exist('probtfgene','var')) || (isempty(probtfgene))
    ...
    for  i = 1:length(regulated)
        ...
        if ~isempty(k) & ~isempty(l)
            ...
            tec = data(k,:); %target genes
            
            tec1 = data(l,:); %regulators
            ...
            try kstest2(te(tec1 == 1),te(tec1== 0));
                ...
                if  (kstest2(te(tec1 == 1),te(tec1== 0)) == 1),
                    ...
                    prob1 = sum(tec(tec1 == 1))/length(tec(tec1==1));
                    probtfgene(i) = prob1;
                    cou = cou + 1;
