function [f,f_ko,v,v_ko,status1,lostxns,probtfgene] =  promv2modelboundflux(model,expression,expressionid,regulator,regulated,litevidence,prob_prior,subsets,KAPPA,datathresh,probtfgene)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
